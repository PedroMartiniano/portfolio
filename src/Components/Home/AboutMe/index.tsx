                    ...
                    <div className="flex flex-col gap-6 border-l-2 border-gray-950">
                        <div className="pl-4">
                            ...
                            <div className="relative bottom-5">
                                ...
                                <p className="text-sm">Meu nome é Pedro Paulino Martiniano, tenho 19 anos e sou um desenvolvedor backend em busca de uma nova oportunidade para mostrar meu conhecimento! Iníciei no mundo da programação como quase todo mundo, aprendendo HTML, CSS e  JavaScript, e fui progredindo para bibliotecas e frameworks como o ReactJs e NextJs, porém descobri que minha verdadeira paixão é o BackEnd, que é onde eu estou depositando todas minhas horas de estudo diário para me aprofundar cada dia mais nesse mundo!</p>
                            </div>
                        </div>
                        <div className="pl-4">
                            <div className="relative bottom-5">
                                ...
                                <p className="text-sm">Iniciei meus estudos aprofundados em backend no começo de 2023, com o NodeJs, e descobri que realmente amava fazer aquilo, tenho também o desejo de aprendender diferentes linguagens backend's. Possuo conhecimento prático em criação e manutenção de API's Rest utilizando NodeJs, juntamente com express, fastify e bibliotecas como JWT, zod, Prisma, KnexJs e MySQL2. Possuo conhecimento prévio em banco de dados MySQL, PostgreSQL e MongoDB.</p>
                            </div>
                        </div>
