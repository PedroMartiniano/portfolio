                    ...
                    <div className="flex flex-col gap-5 border-l-2 border-gray-950">
                        ...
                        <div className="pl-4">
                            ...
                            <div className="relative bottom-5">
                                ...
                                <p className="my-1 text-sm ml-4 text-justify">Responsável pelo desenvolvimento e manutenção de APIs Rest e Orientadas a Eventos em ambiente de microsserviços utilizando tecnologias como NodeJs, TypeScript, Python, Apache Kafka, Docker e Aws Lambda. Visando escalabilidade, segurança, e performance, utilizando metodologias como clean code, SOLID principles e scrum para metodologia ágil.</p>
                            </div>
                        </div>
